(() => {
  ...
  function SidebarLeft({ connectionStatus, onGoHome, onNewSession, conversations = [], activeConvId, onSelectConv, projectPath, onSelectProject }) {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "sidebar-body", style: { WebkitAppRegion: "no-drag" }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { padding: "12px 14px 0" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "project-icon", children: "\u{1F4C2}" }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "project-path", children: projectPath ? projectPath.split(/[\\/]/).pop() : "Add Project" }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "project-change", children: projectPath ? "Change" : "Browse" })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "section-label", style: { marginTop: 12 }, children: "Conversations" }),
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: `mode-track ${mode === "pending" ? "pending" : isCloud ? "cloud" : "secure"}`, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "mode-dot" }) }),
...
Please report this to https://github.com/markedjs/marked.`, e) {
  ...
  function formatDiagnosis(html2) {
    if (!html2.includes("CAUSE:") || !html2.includes("FIX:")) return html2;
    return html2.replace(/CAUSE:\s*/g, '<div class="diag-section diag-cause"><span class="diag-label">CAUSE</span> ').replace(/FIX:\s*/g, '</div><div class="diag-section diag-fix"><span class="diag-label">FIX</span> ').replace(/ALSO CHECK:\s*/g, '</div><div class="diag-section diag-check"><span class="diag-label">ALSO CHECK</span> ') + "</div>";
  }
  function renderMarkdown(text2) {
    if (!text2) return "";
    const raw = g.parse(text2);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "chat-area", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "messages-area", children: messages.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "empty-state", children: [
        ...
        messages.map((msg) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: `message-row ${msg.role}`, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: `message-bubble ${msg.role}`, children: [
          msg.role === "jarvis" ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "markdown-content", dangerouslySetInnerHTML: { __html: renderMarkdown(msg.text) } }) : msg.text,
          msg.streaming && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "streaming-cursor", children: "\u258A" })
        ] }) }, msg.id)),
        activeTools.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "tool-progress", children: activeTools.map((t, i) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: `tool-progress-item ${t.status || "running"}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: `tool-progress-dot ${t.status || "running"}` }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "tool-name", children: [
            TOOL_LABELS[t.tool] || t.tool,
            "..."
          ] }),
          t.params && Object.keys(t.params).length > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "tool-params", children: Object.entries(t.params).map(([k2, v2]) => `${k2}: ${v2}`).join(", ") }),
          t.status === "done" && t.duration != null && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "tool-duration", children: [
            t.duration,
            "ms"
          ] })
        ] }, i)) }),
  ...
  function App() {
    ...
    const discardStreamRef = (0, import_react3.useRef)(false);
    const manualSplashRef = (0, import_react3.useRef)(false);
    ...
    const [reports, setReports] = (0, import_react3.useState)(() => {
      try {
        return JSON.parse(localStorage.getItem("jarvis_reports") || "[]");
      } catch {
        return [];
      }
    });
    ...
    const [projectPath, setProjectPath] = (0, import_react3.useState)(null);
    ...
    (0, import_react3.useEffect)(() => {
      if (activeConvId && messages.length > 0) {
        setConversations((prev) => prev.map(
          (c) => c.id === activeConvId ? { ...c, messages } : c
        ));
      }
    ...
    const { sendMessage, connectionStatus } = useWebSocket("ws://localhost:8765", {
      ...
      onToolCallStatus: (event) => {
        if (event.status === "start") {
          ...
          setActiveTools((prev) => prev.map(
            (t) => t.tool === event.tool && t.status === "running" ? { ...t, status: "done", duration: event.duration_ms } : t
          ));
          setTimeout(() => {
            setActiveTools((prev) => prev.filter(
              (t) => !(t.tool === event.tool && t.status === "done")
            ));
          }, 1500);
        }
      }
    ...
    const handleSend = (0, import_react3.useCallback)((text2) => {
      discardStreamRef.current = false;
      if (!text2.trim() || isStreaming) return;
      dispatch({ type: "ADD_USER_MESSAGE", text: text2.trim() });
      dispatch({ type: "START_STREAM" });
      isStreamingRef.current = true;
      setIsStreaming(true);
      sendMessage({ event: "user_query", query: text2.trim(), mode });
      if (messages.length === 0 && !activeConvId) {
        const id = Date.now().toString();
        const title = text2.trim().slice(0, 40) + (text2.trim().length > 40 ? "..." : "");
        setActiveConvId(id);
        setConversations((prev) => [{ id, title, time: (/* @__PURE__ */ new Date()).toLocaleTimeString(), messages: [] }, ...prev]);
      }
    ...
    const handleSelectConv = (0, import_react3.useCallback)((convId) => {
    ...
    const handleSelectProject = (0, import_react3.useCallback)(async () => {
